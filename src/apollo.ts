...
const httpLink = new HttpLink({
  uri: isDev? "http://localhost:4000/graphql" : "https://nameless-beach-79733.herokuapp.com/graphql"
});
...
const wsLink = new WebSocketLink({
  ...
  uri: isDev? "ws://localhost:4000/subscription" : "wss://nameless-beach-79733.herokuapp.com/subscription"
});
